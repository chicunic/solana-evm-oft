...
task("lz:oft:solana:create", "Mints new SPL Token and creates new OFT Store account")
  ...
  .addParam("name", "Token Name", "Sidekick", devtoolsTypes.string)
  ...
  .addParam("symbol", "Token Symbol", "K", devtoolsTypes.string)
  ...
  .setAction(
    async ({
      ...
      const lockboxSigner = createSignerFromKeypair({ eddsa }, lockBox);
      ...
      saveSolanaDeployment(eid, programIdStr, mint.publicKey, mintAuthorityPublicKey.toBase58(), escrowPK, oftStorePda);
    },
  );
